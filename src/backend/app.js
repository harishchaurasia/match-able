...
// New endpoint that doesn't require authentication
app.get("/calculate-similarity-test", async (req, res) => {
    try {
        const email = "cseth@asu.edu"; // Hardcoded email
        console.log("Calculating similarity for hardcoded user:", email);
        ...
        const pythonPath = '/Users/chiragseth/Desktop/HackPrinceton/test/match-able/venv/bin/python3';
        const pythonScriptPath = '/Users/chiragseth/Desktop/HackPrinceton/test/match-able/src/ai-ml/accessibilitySimilarity.py';
